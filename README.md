...
Render a script element which will mount the compontent the container 
...
and instead rely on a global variable, `React`. Omitting React from the bundle allows
multiple components to be included within a single page without duplicating React's
code.
